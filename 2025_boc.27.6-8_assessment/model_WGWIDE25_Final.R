#WGWIDE 2025 Boarfish Final Assessment
#30th September 2025
...
replist$timeseries$SpawnBio[replist$timeseries$Yr==2025]/1e6   #0.758773
replist$maximum_gradient_component #3.85192e-07
replist$likelihoods_used$values[1] #615.883
...
if (do.STF) {
  ...
  FMult.Blim <- seq(39.303,39.305,by=0.001)
  ...
  FMult.MSYBtrigger <- seq(33.895,33.897,by=0.001)
...
replist$likelihoods_used[1,]  #615.883
...
if (do.jitter) {
  ...
  table(jit.likes)
  #jit.likes
  #615.883 620.296 625.271  632.65 847.901 877.403 
  #13       1       3       1       2       5
